...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/1705h?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("examin_user","User","1705h").init();  
        new GenEntityOracle("examin_package","Package","1705h").init();  
        new GenEntityOracle("user_orders","Orders","1705h").init();  
    }  
}